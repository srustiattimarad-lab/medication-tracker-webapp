...
# -----------------------------
# SAFE PATH (WORKS FOR EXE + VS CODE)
# -----------------------------
...
DB = resource_path("medtracker.db")

app = Flask(__name__)
app.secret_key = "medtracker_secret"
...
def index():
    ...
    for med in meds:
        ...
        display_time = med_time_obj.strftime("%I:%M %p")
        ...
        if history:
            ...
            if datetime.now().time() > med_time_obj.time():
